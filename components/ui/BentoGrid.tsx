...
export const BentoGridItem = ({
  ...
  const rightLists = ["Python", "NextJS", "AWS"];
  ...
  const handleCopy = () => {
    const text = "timchelelgo@gmail.com";
  ...
  return (
    <div
      ...
      style={{
        ...
        background: "linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(9,103,121,1) 35%, rgba(8,73,88,1) 100%)"
      }}
    >
      {/* add img divs */}
